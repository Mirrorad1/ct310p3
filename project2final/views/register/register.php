...
<?php echo Form::open('index.php/register/register'); ?>
   	<div class="panel panel-default">
	  	<div class="panel-heading">
	 	</div>
	  	<div class="panel-body">
	    	<form action="index.php/register.php" method="POST" accept-charset="UTF-8" role="form">
                  <fieldset>
	    		...
	    		<?php echo Form::submit('send'); ?> </div>
	   	   	...
	   	   	<p>Forgot password? <a href="<?=Uri::create('index.php/reset/grabemail');?>">Click here to reset</a></p>
	    	</fieldset>
	      	</form>
	    </div>
	</div>
