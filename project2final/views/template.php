...
<html lang="en">
  <head>
    ...
    <meta name="author" content=" Mirro Radosavlevici" >
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark  bg-dark fixed-top" style="background-color: #e3f2fd;" >
      <a class="navbar-brand" href="https://en.wikipedia.org/wiki/Kansas">Travel</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		?>
         ...
         <a class="nav-link" href="<?=Uri::create('index.php/posts/addAttraction'); ?>">Add Attraction<span class="sr-only">(current)</span></a>	
			<a class="nav-link" href="<?=Uri::create('index.php/posts/logout.php'); ?>">Logout<span class="sr-only">(current)</span></a>
		<?php elseif (isset($username) && $usid == 12345) : ?>
			<a class="nav-link" href="<?=Uri::create('index.php/posts/logout.php'); ?>">Logout<span class="sr-only">(current)</span></a>
			<?php else : ?>
			<a class="nav-link " href="<?=Uri::create('index.php/posts/register.php'); ?>">Register<span class="sr-only">(current)</span></a>
